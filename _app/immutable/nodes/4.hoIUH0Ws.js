const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../chunks/DOa5FWDk.js","../chunks/v8CyTVq-.js","../chunks/BIYjCGev.js","../assets/markdown.BPWJwfct.css","../assets/vendor.EFy4xGvE.css"])))=>i.map(i=>d[i]);
import{i as Rt,P as Vt,t as B,B as lt,a as At}from"../chunks/B9_kP_H2.js";import{ac as Ot,p as ct,a as st,i as vt,f as D,a9 as _t,e as u,x as X,j as a,r,B as d,a1 as Ct,t as Y,n as St,z as i,y as n,h,D as E,a2 as Tt,a3 as q,T as M,d as nt,ad as at,w as dt,K as Ut,s as ot,g as mt,_ as P,o as It,V as Wt,u as Ft,m as Bt,ae as Mt,W as qt,af as zt}from"../chunks/v8CyTVq-.js";import{F as L,d as xt,e as bt,g as wt,i as Ht,c as kt,f as Kt,j as Nt,h as Gt}from"../chunks/BdsavApn.js";import{W as pt}from"../chunks/06yxlkCM.js";const Jt=async({url:y,fetch:x})=>{const t=new Vt,e=y.pathname.split("/").slice(-1)[0],s=Rt.find(o=>o.id===e);if(s===void 0)throw Ot(404,"Project not found");return{project:s,projectService:t,fetch:x}},fe=Object.freeze(Object.defineProperty({__proto__:null,load:Jt},Symbol.toStringTag,{value:"Module"})),Qt=(y,x)=>{const t=new x.Renderer;return t.heading=(e,s)=>`<h${s} class="my-4 font-cascadia-mono dark:text-white">${e}</h${s}>`,t.paragraph=e=>`<span class="text-slate-600 dark:text-slate-300 mb-2">${e}</span><br>`,t.strong=e=>`<span class="font-bold text-black dark:text-white">${e}</span>`,t.list=(e,s)=>{const o=s?"ol":"ul";return'<div class="my-4"><'+o+`start="0">
`+e+"</"+o+`></div>
