const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../chunks/DbqZsee8.js","../chunks/IkAFp7Hu.js","../chunks/CY4uePOB.js","../chunks/CEi0rbLP.js","../assets/markdown.BPWJwfct.css","../assets/vendor.jL1egRUS.css","../chunks/BiEE8sZ_.js","../chunks/DfTtQ1R-.js"])))=>i.map(i=>d[i]);
import{i as Rt,P as At,t as Y,a as Ot}from"../chunks/N3WpNRTc.js";import{ah as Vt,p as it,G as L,_ as xt,e as m,f as H,k as a,r,s,a8 as Tt,t as G,v as Ct,g as V,y as P,a9 as It,A as St,a2 as W,W as F,d as ft,O as Z,c as ut,F as Ut,w as Ft,q as N,h as lt,T as Wt,ad as qt,$ as Mt,a1 as zt,ae as Bt}from"../chunks/CY4uePOB.js";import{_ as h}from"../chunks/C9I8_Wex.js";import{F as y,e as ot,g as bt,h as _t,i as wt,k as Ht,b as Gt,f as Nt,j as pt}from"../chunks/B-IURsu-.js";import{B as $}from"../chunks/DolWr6r4.js";import{W as nt}from"../chunks/aj1LI4AC.js";const Jt=async({url:j,fetch:t})=>{const n=new At,e=j.pathname.split("/").slice(-1)[0],o=Rt.find(g=>g.id===e);if(o===void 0)throw Vt(404,"Project not found");const d=o.readmeUrl?n.getProjectReadme({project:o,fetch:t}):Promise.resolve("<h2>No README file</h2>");return{project:o,projectService:n,fetch:t,markdownPromise:d}},xe=Object.freeze(Object.defineProperty({__proto__:null,load:Jt},Symbol.toStringTag,{value:"Module"})),Kt=(j,t)=>{const n=new t.Renderer;return n.heading=(e,o)=>`<h${o} class="my-4 font-cascadia-mono dark:text-white">${e}</h${o}>`,n.paragraph=e=>`<span class="text-slate-600 dark:text-slate-300 mb-2">${e}</span><br>`,n.strong=e=>`<span class="font-bold text-black dark:text-white">${e}</span>`,n.list=(e,o)=>{const d=o?"ol":"ul";return'<div class="my-4"><'+d+`start="0">
`+e+"</"+d+`></div>
