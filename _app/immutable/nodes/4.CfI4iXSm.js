const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../chunks/uOLbRylp.js","../chunks/CO8XG5rT.js","../chunks/BGU01sQD.js","../chunks/CEi0rbLP.js","../assets/markdown.BPWJwfct.css","../assets/vendor.jL1egRUS.css","../chunks/BiEE8sZ_.js","../chunks/DfTtQ1R-.js"])))=>i.map(i=>d[i]);
import{i as Re,P as Ae,t as Y,a as Oe}from"../chunks/CWWsD4tJ.js";import{ah as Ve,p as oe,G as L,_ as xe,e as v,f as H,k as a,r,s,a8 as Te,t as G,v as Ce,g as V,y as P,a9 as Ie,A as Se,a2 as W,W as F,d as fe,O as Z,c as pe,F as Ue,w as Fe,q as N,h as ie,T as We,ad as qe,$ as Me,a1 as ze,ae as Be}from"../chunks/BGU01sQD.js";import{_ as h}from"../chunks/DcluThlX.js";import{F as y,e as le,g as _e,h as be,i as we,k as He,b as Ge,f as Ne,j as ge}from"../chunks/PVi4reTT.js";import{B as $}from"../chunks/DEtm16B6.js";import{W as ne}from"../chunks/CygLv91_.js";const Je=async({url:j,fetch:e})=>{const n=new Ae,t=j.pathname.split("/").slice(-1)[0],l=Re.find(u=>u.id===t);if(l===void 0)throw Ve(404,"Project not found");const d=l.readmeUrl?n.getProjectReadme({project:l,fetch:e}):Promise.resolve("<h2>No README file</h2>");return{project:l,projectService:n,fetch:e,markdownPromise:d}},xt=Object.freeze(Object.defineProperty({__proto__:null,load:Je},Symbol.toStringTag,{value:"Module"})),Ke=(j,e)=>{const n=new e.Renderer;return n.heading=(t,l)=>`<h${l} class="my-4 font-cascadia-mono dark:text-white">${t}</h${l}>`,n.paragraph=t=>`<span class="text-slate-600 dark:text-slate-300 mb-2">${t}</span><br>`,n.strong=t=>`<span class="font-bold text-black dark:text-white">${t}</span>`,n.list=(t,l)=>{const d=l?"ol":"ul";return'<div class="my-4"><'+d+`start="0">
`+t+"</"+d+`></div>
