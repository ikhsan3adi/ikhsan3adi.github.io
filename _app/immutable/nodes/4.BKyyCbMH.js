const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../chunks/_1bTrCE0.js","../chunks/CI2jKuTe.js","../chunks/BIYjCGev.js","../assets/markdown.BPWJwfct.css","../assets/vendor.z57soX09.css"])))=>i.map(i=>d[i]);
import{i as Rt,P as Vt,t as B,a as At}from"../chunks/4vn70eXn.js";import{ae as Ot,p as dt,a as at,i as ct,f as V,V as _t,e as u,x as K,j as a,r,B as d,a3 as Ct,t as G,n as St,z as s,y as n,h as $,D as R,a4 as Tt,Y as q,T as M,d as lt,af as rt,w as nt,K as Ut,s as J,g as vt,_ as L,o as It,aa as Wt,W as Ft,u as Bt,m as Mt,$ as qt,ab as zt}from"../chunks/CI2jKuTe.js";import{F as D,g as xt,h as bt,i as wt,k as Ht,e as kt,b as Kt,f as Nt,j as ft}from"../chunks/a0F3k6V-.js";import{B as ot}from"../chunks/BsEs2ugZ.js";import{W as mt}from"../chunks/CrqIE8j7.js";const Yt=async({url:j,fetch:x})=>{const t=new Vt,e=j.pathname.split("/").slice(-1)[0],l=Rt.find(o=>o.id===e);if(l===void 0)throw Ot(404,"Project not found");return{project:l,projectService:t,fetch:x}},fe=Object.freeze(Object.defineProperty({__proto__:null,load:Yt},Symbol.toStringTag,{value:"Module"})),Gt=(j,x)=>{const t=new x.Renderer;return t.heading=(e,l)=>`<h${l} class="my-4 font-cascadia-mono dark:text-white">${e}</h${l}>`,t.paragraph=e=>`<span class="text-slate-600 dark:text-slate-300 mb-2">${e}</span><br>`,t.strong=e=>`<span class="font-bold text-black dark:text-white">${e}</span>`,t.list=(e,l)=>{const o=l?"ol":"ul";return'<div class="my-4"><'+o+`start="0">
`+e+"</"+o+`></div>
