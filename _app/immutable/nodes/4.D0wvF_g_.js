const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../chunks/LdOlIm-6.js","../chunks/BU3_Mqfp.js","../chunks/BIYjCGev.js","../assets/markdown.BPWJwfct.css","../assets/vendor.z57soX09.css"])))=>i.map(i=>d[i]);
import{i as Rt,P as Vt,t as B,B as rt,a as At}from"../chunks/Bf6_kM0n.js";import{ac as Ot,p as nt,a as at,i as dt,f as R,a9 as xt,e as u,x as G,j as a,r,B as d,a1 as Ct,t as et,n as St,z as i,y as n,h,D,a2 as Tt,a3 as q,T as M,d as lt,ad as tt,w as it,K as Ut,s as ut,g as ct,_ as E,o as It,V as Wt,u as Ft,m as Bt,ae as Mt,W as qt,af as zt}from"../chunks/BU3_Mqfp.js";import{F as L,d as _t,e as bt,g as wt,i as Ht,c as kt,f as Kt,j as Nt,h as ft}from"../chunks/CUuJTpPn.js";import{W as vt}from"../chunks/CJKWfKb4.js";const Gt=async({url:y,fetch:_})=>{const t=new Vt,e=y.pathname.split("/").slice(-1)[0],l=Rt.find(o=>o.id===e);if(l===void 0)throw Ot(404,"Project not found");return{project:l,projectService:t,fetch:_}},ge=Object.freeze(Object.defineProperty({__proto__:null,load:Gt},Symbol.toStringTag,{value:"Module"})),Jt=(y,_)=>{const t=new _.Renderer;return t.heading=(e,l)=>`<h${l} class="my-4 font-cascadia-mono dark:text-white">${e}</h${l}>`,t.paragraph=e=>`<span class="text-slate-600 dark:text-slate-300 mb-2">${e}</span><br>`,t.strong=e=>`<span class="font-bold text-black dark:text-white">${e}</span>`,t.list=(e,l)=>{const o=l?"ol":"ul";return'<div class="my-4"><'+o+`start="0">
`+e+"</"+o+`></div>
