...
const projects: Project[] = [
	...
	},
	{
		...
		imageUrl:
			'https://w7.pngwing.com/pngs/404/667/png-transparent-coming-soon-text-service-sales-united-states-quotation-customer-coming-soon-miscellaneous-angle-text-thumbnail.png',
		tags: []
	}
];
